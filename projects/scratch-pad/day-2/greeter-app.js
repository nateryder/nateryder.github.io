...
function greeter(hour) {
    ...
    // if the hour is less than or equal to 11 than it will print good moring
    if(hour <= 11){
    ...
    // if the hour is less than or equal to 21 it will print good evening
    else if (hour <= 21){
        console.log("Good Evening!");
    } 
    // if the hour is greater than 22 it will print good night
    else {
